...
path_dir = "../../sec_data/all_results/model_dir/final/starcoder2-3b/starcoder2-3b"
...
for vul in all_vuls:
    ...
    fc_baseline_path = f"../../sec_data/all_results/fc_baseline_test/starcoder2-3b/temp_0.4/{lang}"
